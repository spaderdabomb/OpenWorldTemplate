		...
		public void RenderAllDeferredGroups( AmplifyImpostorAsset data = null )
		{
			...
			if( m_data.Preset == null )
			{
				if( m_renderPipelineInUse == RenderPipelineInUse.HDRP )
					...
					m_data.Preset = AssetDatabase.LoadAssetAtPath<AmplifyImpostorBakePreset>( AssetDatabase.GUIDToAssetPath( PresetBiRP ) );
			}
			...
			m_standardFileNames[ 0 ] = Preferences.GlobalAlbedoAlpha;
			m_standardFileNames[ 1 ] = Preferences.GlobalSpecularSmoothness;
			m_standardFileNames[ 2 ] = Preferences.GlobalNormalDepth;
			m_standardFileNames[ 3 ] = Preferences.GlobalEmissionOcclusion;
