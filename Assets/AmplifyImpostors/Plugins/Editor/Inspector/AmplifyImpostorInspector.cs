		...
		public void OnEnable()
		{
			...
			if( m_currentData.Preset == null )
			{
				...
				if( m_instance.m_renderPipelineInUse == RenderPipelineInUse.HDRP )
					...
					m_currentData.Preset = AssetDatabase.LoadAssetAtPath<AmplifyImpostorBakePreset>( AssetDatabase.GUIDToAssetPath( AmplifyImpostor.PresetBiRP ) );
				...
				EditorGUILayout.BeginVertical( "helpbox" );
				{
					...
					if( GUILayout.Button( "New", "minibutton", GUILayout.Width( 50 ) ) )
					{
						...
						if( !string.IsNullOrEmpty( folderpath ) )
						{
							...
							{
								new TextureOutput(true, Preferences.GlobalAlbedoAlpha, TextureScale.Full, true, TextureChannels.RGBA, TextureCompression.Normal, ImageFormat.TGA ),
								new TextureOutput(true, Preferences.GlobalSpecularSmoothness, TextureScale.Full, true, TextureChannels.RGBA, TextureCompression.Normal, ImageFormat.TGA ),
								new TextureOutput(true, Preferences.GlobalNormalDepth, TextureScale.Full, false, TextureChannels.RGBA, TextureCompression.Normal, ImageFormat.TGA ),
								new TextureOutput(true, Preferences.GlobalEmissionOcclusion, TextureScale.Full, false, TextureChannels.RGBA, TextureCompression.Normal, ImageFormat.TGA ),
							};
